...
class AppTheme {
  ...
  static const Color primaryButtonColor = Color(0xFF9F988F);
   static const Color secondaryButtonColor = Color(0xFF2B2D41);
  static const String fontName = 'Roboto';
   static const Color boxColor =   Color.fromRGBO(43, 45, 65, 0.9);
    static const Color boxtextColor =   Color.fromRGBO(43, 45, 65, 0.5);
...
static ThemeData buildLightTheme() {
    final Color primaryColor = HexColor('#ff4d4d');
