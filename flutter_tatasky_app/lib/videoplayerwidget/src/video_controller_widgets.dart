...
_backwardAction() {
    ...
    var position = controller.value.position.inSeconds;
  ...
  _forwardAction() {
    ...
    var position = controller.value.position.inSeconds;
    position = min(controller.value.duration.inSeconds, position + 10);
...
class _TopBarState extends State<TopBar> {
  ...
  Widget build(BuildContext context) {
    return Visibility(
      ...
      child: Padding(
        padding:
         EdgeInsets.only(left: 2.0, right: 2.0, top: MediaQuery.of(context).padding.top),
        child: Row(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(
           ...
           controller==null?Container():IconButton(
            icon: Icon(
             (_controllerWrapper.value!=null  && controller.value.volume> 0 ) ? Icons.volume_up : Icons.volume_off,
              color: Colors.white,
              ),
            onPressed:(){
